...
(deftheme tk-nord "An arctic, north-bluish clean and elegant theme")

(defgroup tk-nord nil
...
;;;; +------------+
  (custom-theme-set-faces
   ...
   `(diff-hl-delete ((,class (:background ,nord11))))
    ...
    ;; > Org
    `(org-level-1 ((,class (:foreground ,nord7 :weight bold :height 1.5))))
    `(org-level-2 ((,class (:foreground ,nord8 :weight bold :height 1.25))))
    `(org-level-3 ((,class (:foreground ,nord9 :weight bold :height 1.15))))
    `(org-level-4 ((,class (:foreground ,nord10 :weight bold :height 1.05))))
    `(org-level-5 ((,class (:foreground ,nord6 :weight bold))))
    `(org-level-6 ((,class (:foreground ,nord6 :weight bold))))
    ...
    ;; tk-customization ----------------------------------------------------------------
    ; To make org block to have background that extends to the end of
    ; line giving it a distinct look, use `:extend t' option as shown
    ; below.
    `(org-block ((,class (:foreground ,nord4 :background ,nord1 :extend t))))
    `(org-block-background ((,class (:background ,nord0))))
    `(org-block-begin-line ((,class (:foreground ,nord9 :background ,nord2 :extend t))))
    `(org-block-end-line ((,class (:foreground ,nord9 :background ,nord2 :extend t))))
    ...
    `(org-document-title ((,class (:foreground ,nord11 :weight bold :height 1.5))))
